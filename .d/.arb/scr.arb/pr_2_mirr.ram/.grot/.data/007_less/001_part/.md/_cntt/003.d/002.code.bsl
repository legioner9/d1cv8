...
Процедура ПередЗаписью(Отказ, РежимЗаписи, РежимПроведения)
	...
	РекДокПокупкаСуммаДокумента = 0;  
	// Автозаполнение РекДокПокупкаСуммаДокумента 
	Для Каждого СтрокаДокумента Из ТабчДокПокупкаПродукты Цикл
		РекДокПокупкаСуммаДокумента = РекДокПокупкаСуммаДокумента + СтрокаДокумента.РекТабчДокПокупкаПродуктыКоличество * СтрокаДокумента.РекТабчДокПокупкаПродуктыЦена ;
	КонецЦикла;  
КонецПроцедуры

Процедура ОбработкаПроведения(Отказ, Режим)  
 
	// Запрет проведения пустого документа
